                              ...
                              @endif
                                ...
                                <div class="table-responsive">
                                   <div class="adv-table-table__header">
                                      <b>
                                      <h4 style="font-size: 18px">Pengambilan Item</h4>
                                      </b>
                                          ...
                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="modalCenterTitle">Ubah Status Pengambilan Item</h5>
                                              ...
                                              <div class="modal-body">
                                                <div class="row">
                                                  ...
                                                  @if ( $transaksi->harga_addons_service > 0)
                                                  <div class="col-12 mb-3">
                                                    <label for="nameWithTitle" class="form-label">Biaya Terhutang :</label><br>
                                                     - Addons service : Rp {{ number_format($transaksi->harga_addons_service,0,',','.') }}
                                                    @if ( $transaksi->status_pembayaran === 'UNPAID' || $transaksi->status_pembayaran === 'POSTPAID')
                                                     <br>
                                                     - Biaya Layanan : Rp {{ number_format($transaksi->total_tagihan,0,',','.') }}
                                                    @endif
                                                    <br>
                                                    Total Tagihan Terhutang : Rp {{ number_format($transaksi->total_tagihan+$transaksi->harga_addons_service,0,',','.') }}
                                                  ...
                                                  <div class="col-12 mb-3">
                                                    <label for="nameWithTitle" class="form-label">Status Pengambilan Item</label>
                                                    <select class="select form-control" name="status_pengambilan" required>
                                                      @if ($transaksi->status_pengambilan === 'Belum Diambil')
