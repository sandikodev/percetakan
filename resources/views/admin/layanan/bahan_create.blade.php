...
{!! Form::open(array('route' => 'layanan.post_bahan','method'=>'POST')) !!}

<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <center>
            <b>
          <h4 style="font-size: 18px">Tambah Jenis Bahan</h4>
            </b>
        </center>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            {!! Form::text('nama_bahan', null, array('placeholder' => 'Nama Bahan','class' => 'form-control')) !!}
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            {!! Form::number('panjang', null, array('placeholder' => 'Panjang dalam cm','class' => 'form-control')) !!}
        </div>
    </div>
