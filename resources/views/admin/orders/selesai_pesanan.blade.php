                              ...
                              @endif
                                ...
                                <div class="table-responsive">
                                   <div class="adv-table-table__header">
                                      <b>
                                      <h4 style="font-size: 18px">Pesanan Selesai</h4>
                                      </b>
                                          ...
                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="modalCenterTitle">SELESAI</h5>
                                              ...
                                              <div class="modal-body">
                                                <div class="row">
                                                  <input name="status_order" value="SELESAI" hidden>
                                                  <div class="col-12 mb-3">
                                                    <label for="nameWithTitle" class="form-label">Biaya Addons</label>
                                                      <input name="biaya_addons" type="number" class="form-control" required>
                                                  </div>
                                                </div>
                                              </div>
