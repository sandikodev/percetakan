                              ...
                              @endif
                                ...
                                <div class="table-responsive">
                                   <div class="adv-table-table__header">
                                      <b>
                                      <h4 style="font-size: 18px">Pesanan Pending</h4>
                                      </b>
                                        ...
                                        @foreach ($transaksi as $transaksi)
                                         <tr>
                                           ...
                                           <td>
                                            ...
                                            <td>
                                              <div class="userDatatable-content">Rp {{ number_format($transaksi->harga_addons_service,0,',','.') }}</div>
                                            </td>
                                            <td>
                                              <div class="userDatatable-content">Rp {{ number_format($transaksi->harga_addons_service + $transaksi->total_tagihan,0,',','.') }}</div>
                                            </td>
                                           <td>
                                          ...
                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <div class="row">
                                                 <input name="status_order" value="PENDING" hidden>
                                                ...
                                                <div class="col-4 mb-3">
                                                  ...
                                                  <div class="col-12 mb-3">
                                                    <label for="nameWithTitle" class="form-label">Biaya Addons <small><font color="green">*opsional</font></small></label>
                                                      <input name="biaya_addons" type="number" class="form-control" placeholder="Masukan Biaya Addons" autofocus>
                                                  </div>
                                                  <div class="col-12 mb-3">
                                                    <small>*Informasi : Input Biaya Addons Jika ada, saat tekan tombol "Save Changes" otomatis orderan pindah ke status <b>PROSES</b> </small>
                                                  </div>
                                                </div>
                                              </div>
