                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="userDatatable-content d-inline-block">
                                                            ...
                                                            @endphp
                                                            <span
                                                                class="bg-opacity-{{ $label_so }}  color-{{ $label_so }} rounded-pill userDatatable-content-status active">{{ $transaksi->status_pembayaran }}</span>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <input name="status_order" value="PENDING"
                                                                            hidden>
