                                      ...
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            <div class="row">
                                             <input name="status_order" value="PROSES" hidden>
                                            ...
                                            <div class="col-4 mb-3">
                                              ...
                                              <div class="col-12 mb-3">
                                                <label for="nameWithTitle" class="form-label">Biaya Addons <small><font color="green">*opsional</font></small></label>
                                                  <input name="biaya_addons" type="number" class="form-control" value="{{$transaksi->harga_addons_service}}" placeholder="Masukan Biaya Addons" autofocus>
                                              </div>
                                              <div class="col-12 mb-3">
                                                <small>*Informasi : Input Biaya Addons Jika ada, saat tekan tombol "Save Changes" otomatis orderan pindah ke status <b>SELESAI</b> </small>
                                              </div>
                                            </div>
                                          </div>
