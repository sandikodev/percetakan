            ...
            <div class="navbar-left">
                <div class="logo-area">
                    ...
                    <a href="#" class="sidebar-toggle">
                        <img class="svg" src="{{ asset('percetakan/img/svg/align-center-alt.svg') }}"
                            alt="img"></a>
                </div>
            </div>
            <div class="navbar-right">
                    ...
                    <li class="nav-author">
                        <div class="dropdown-custom">
                            <a href="javascript:;" class="nav-item-toggle"><img
                                    src="{{ asset('percetakan/img/user-profile.png') }}" alt class="rounded-circle">
                                ...
                                <div class="dropdown-wrapper">
                                    <div class="nav-author__info">
                                        <div class="author-img">
                                            <img src="{{ asset('percetakan/img/user-profile.png') }}" alt
                                    ...
                                    <div class="nav-author__options">
                                        ...
                                        <a href="{{ route('logout') }}"
                                            ...
                                            target="_blank" class="nav-author__signout">
                ...
                <div class="navbar-right__mobileAction d-md-none">
                    <a href="#" class="btn-author-action">
                        <img class="svg" src="{{ asset('percetakan/img/svg/more-vertical.svg') }}"
                            alt="more-vertical"></a>
                </div>
            </div>
        </nav>
                ...
                <div class="sidebar__menu-group">
                    <ul class="sidebar_nav">
                        @role(['Admin', 'Superadmin'])
                            ...
                            <li
                                class="has-child {{ Request::segment(2) == 'semua-pesanan' || Request::segment(2) == 'pending-pesanan' || Request::segment(2) == 'unpaid-pesanan' || Request::segment(2) == 'proses-pesanan' || Request::segment(2) == 'selesai-pesanan' ? 'open' : '' }}">
                                <a href="#"
                                    class="has-child {{ Request::segment(2) == 'semua-pesanan' || Request::segment(2) == 'pending-pesanan' || Request::segment(2) == 'proses-pesanan' || Request::segment(2) == 'selesai-pesanan' ? 'active' : '' }}">
                                ...
                                <ul>
                                    <li class="{{ Request::segment(2) == 'semua-pesanan' ? 'active' : '' }}">
                                        <a href="{{ URL::to('admin/orders') }}">Semua Pesanan</a>
                                    </li>
                                    <li class="{{ Request::segment(2) == 'unpaid-pesanan' ? 'active' : '' }}">
                                        <a href="{{ URL::to('admin/order/unpaid') }}">Unpaid @if ($total_tagihan_belum_lunas != 0)
                                                <span
                                                    class="badge badge-warning menuItem rounded-circle">{{ $total_tagihan_belum_lunas }}</span>
                                            @endif
                                        </a>
                                    </li>
                                    <li class="{{ Request::segment(2) == 'pending-pesanan' ? 'active' : '' }}">
                                        <a href="{{ URL::to('admin/order/pending') }}">Pending @if ($total_order_pending != 0)
                                                <span
                                                    class="badge badge-warning menuItem rounded-circle">{{ $total_order_pending }}</span>
                                            @endif
                                        </a>
                                    </li>
                                    <li class="{{ Request::segment(2) == 'proses-pesanan' ? 'active' : '' }}">
                                        <a href="{{ URL::to('admin/order/process') }}">Proses @if ($total_order_proses != 0)
                                                <span
                                                    class="badge badge-info menuItem rounded-circle">{{ $total_order_proses }}</span>
                                            @endif
                                        </a>
                                    </li>
                                    <li class="{{ Request::segment(2) == 'selesai-pesanan' ? 'active' : '' }}">
                                        <a href="{{ URL::to('admin/order/done') }}">Selesai @if ($total_order_selesai != 0)
                                                <span
                                                    class="badge badge-success menuItem rounded-circle">{{ $total_order_selesai }}</span>
                                            @endif
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="has-child {{ Request::segment(2) == 'tagihan' ? 'open' : '' }}">
                                ...
                                <ul>
                                    ...
                                    <li class="{{ Request::segment(3) == 'belum-lunas' ? 'active' : '' }}">
                                        <a href="{{ URL::to('admin/tagihan/belum-lunas') }}">Belum Lunas @if ($total_tagihan_belum_lunas != 0)
                                                <span
                                                    class="badge badge-warning menuItem rounded-circle">{{ $total_tagihan_belum_lunas }}</span>
                                            @endif
                                        </a>
                                    ...
                                    <li class="{{ Request::segment(3) == 'lunas' ? 'active' : '' }}">
                                        <a href="{{ URL::to('admin/tagihan/lunas') }}">Lunas @if ($total_tagihan_lunas != 0)
                                                <span
                                                    class="badge badge-success menuItem rounded-circle">{{ $total_tagihan_lunas }}</span>
                                            @endif
                                        </a>
                                    </li>
                                </ul>
                            ...
                            @role('Superadmin')
                                ...
                                <li class="has-child {{ Request::segment(2) == 'settings' ? 'open' : '' }}">
                                    <a href="#"
                                        class="has-child {{ Request::segment(2) == 'settings' ? 'active' : '' }}">
