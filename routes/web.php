...
//========================= ADMIN AREA =============================================// 
        ...
        Route::get('/admin/semua-pesanan', [OrdersController::class, 'semua_pesanan'])->name('orders.semua_pesanan'); 
        Route::get('/admin/unpaid-pesanan', [OrdersController::class, 'unpaid_pesanan'])->name('orders.unpaid_pesanan'); 
        Route::get('/admin/pending-pesanan', [OrdersController::class, 'pending_pesanan'])->name('orders.pending_pesanan'); 
        Route::get('/admin/proses-pesanan', [OrdersController::class, 'proses_pesanan'])->name('orders.proses_pesanan'); 
        Route::get('/admin/selesai-pesanan', [OrdersController::class, 'selesai_pesanan'])->name('orders.selesai_pesanan'); 
