    ...
    return this.each(function () {
      function d() {
        ...
        a("option", e).each(function () {
          a(this).hasClass(h) && a(this).val() === g
            ? (a(this).prop("selected", !0), (d = !1))
            : a(this).hasClass(h) ||
              a(this).hasClass(j) ||
              "" === a(this).val() ||
              a(this).remove();
        }),
          1 === a("option", e).size() && "" === a(e).val()
            ? a(e).attr("disabled", "disabled")
            : a(e).removeAttr("disabled"),
